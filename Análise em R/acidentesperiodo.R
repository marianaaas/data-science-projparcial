...
#estados_filtrados <- c("SC", "RS", "PR")
#data_filter <- data[data$uf %in% estados_filtrados,]
...
shp_sc <- readOGR(dsn = "C:/Users/Usuário/Documents/ciencia de dados/shapefile_sc", 
                  layer = "sc_state",
                  encoding = "UTF-8", 
                  use_iconv = TRUE)
...
cidades <- st_read("C:/Users/Usuário/Documents/ciencia de dados/shapefile_sc/sc_state.shp")
